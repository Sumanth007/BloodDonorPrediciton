            ...
            <div class="header">
                ...
                <div class="top-nav ">
                    ...
                    <li><a href="#">Importance</i></a> </li>                    
                     <li><a href="predict.jsp">Future Donors</a> </li>
                    ...
                    <div class="container" >
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12" style="height:400px;margin:1.5em 1em;">
                                <div class="col-md-6" >
                                    <label>High Blood Donor Taluk</label>
                                    <table class="table-striped" id="high">
                                        <thead>
                                            <tr><th style="width: 250px">Taluk</th><th style="width: 250px">Donors</th></tr>
                                        </thead>
                                        <tbody></tbody>
                                    </table>
                                </div>
                                <div class="col-md-6">
                                    <label>Less Blood Donor Taluk</label>
